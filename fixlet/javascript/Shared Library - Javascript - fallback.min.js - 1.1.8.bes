...
<BES xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="BES.xsd">
	<Task>
		<Title>Shared Library - Javascript - fallback.min.js - 1.1.8</Title>
		<Description><![CDATA[<P>This fixlet is used as a mechanism to make a javascript library available to other fixlets, dashboards, etc... It has no action associated with it and can't be targeted to any computer.</P>]]></Description>
		<Relevance>false</Relevance>
		<Category>Library</Category>
		<!-- download-size-ok: JS payload is embedded in the fixlet as a MIME field, so there is no ActionScript download -->
		<DownloadSize>3611</DownloadSize>
		<Source>http://fallback.io/</Source>
		<SourceID>jgstew</SourceID>
		<SourceReleaseDate>2016-01-06</SourceReleaseDate>
		<SourceSeverity></SourceSeverity>
		<CVENames></CVENames>
		<SANSID></SANSID>
		<MIMEField>
			<Name>name</Name>
			<Value>fallback.min.js</Value>
		</MIMEField>
		<MIMEField>
			<Name>integrity</Name>
			<Value>sha256-Erbfw8R4je8mg7tk17mkn97KStySwj8vecu0G36Tw1M=</Value>
		</MIMEField>
		<MIMEField>
			<Name>version</Name>
			<Value>1.1.8</Value>
