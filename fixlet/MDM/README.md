...
> :warning: **EXPERIMENTAL / UNTESTED.** These fixlets are experimental and have **not** been tested
...
| `MDM Roll Back Latest Quality Update - Windows.bes` | `MDM_Update_Rollback01` - `QualityUpdateMethod` | Latest quality update only; SAC devices. :warning: MS docs swap the two method descriptions - trusts the method **name**. |
